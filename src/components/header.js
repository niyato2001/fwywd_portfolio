...
const Header = () => (
  <div>
    <div className='w-full text-center h-30 laptop_l:h-24'>
      ...
      <div className='w-11/12 ml-auto mr-auto float-none laptop_l:float-right laptop_l:mr-10 laptop_l:w-1/4'>
        <div
          className='text-green-font -mt-3 pb-2 mx-auto h-10 justify-center flex-auto flex items-center font-bold tracking-wider text-lg 
        laptop_l:h-24 laptop_l:mt-0 laptop_l:pb-0'
        >
